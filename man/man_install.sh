...
URL="https://raw.githubusercontent.com/ps81frt/backup-manager-web/refs/heads/main/man/sauvegarde_automatique.man"; NAME="sauvegarde_automatique"; FILE="$NAME.1"; LOCAL="./$FILE"; TMP="/tmp/$FILE"
